...
\end{verbatim}
\section{Caching}\index{MongoDB}\index{caching}
...
\end{itemize}
\section{File system}
Assets are stored on the file system in /home/loncapa/res. The authoritative copy of assets is on the author's homeserver, but they are copied through replication to other servers.\index{homeserver}\index{replication}
