...
When performance data is stored, it is stored under this assetid along wiht the course. As assetids are unique, whole segments of tables of content can be copied between courses.
