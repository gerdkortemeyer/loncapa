...
# Get request object
   ...
   $r->print(&Apache::lc_entity_users::make_new_user('test154','msu',{ lastname => 'Flintstone', firstname => 'Fred' },
                                                                     { domains => { 'msu' => { role => 'coordinator' }}})."\n");
   $entity=&Apache::lc_entity_users::username_to_entity('test154','msu');
